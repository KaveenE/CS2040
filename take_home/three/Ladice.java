...
class UFDS {
	...
	//mapping of drawer i to the final drawer
	int[] finalDrawerInTransition;
	
	public UFDS(int numSingletons)
	{
		parent = new int[numSingletons + 1];
		rank = new int[numSingletons + 1];
		finalDrawerInTransition = new int[numSingletons + 1];
	...
	public void unionSet(int i, int j)
	{
		...
		finalDrawerInTransition[i] = findSet(j);
	}
